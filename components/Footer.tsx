...
export default function Footer() {
  ...
  return (
    <footer className="bg-sage-800 text-sage-100 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sage-200 text-sm mb-4">
              Follow along for cooking tips, new recipes, and kitchen inspiration.
            </p>
        ...
        <div className="border-t border-sage-700 mt-8 pt-8 text-center">
          <p className="text-sage-300 text-sm">
            © {currentYear} Lixi's Kitchen. Made with 💚 and lots of delicious food.
          </p>
        </div>
      </div>
    </footer>
